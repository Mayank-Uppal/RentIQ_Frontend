...
function HomeInput({inputs,buttonList,onsubmit,role,handleClick,legend,handlenavigate,textone,texttwo}:InputRequiredProps) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    return (
        ...
        <div className="dark bg-neutral-primary min-h-screen flex items-center justify-center py-8 px-4">
            <form className="dark bg-neutral-primary max-w-md mx-auto flex flex-col justify-center items-center" onSubmit={handleSubmit(onsubmit)} >
                <fieldset className="dark h-auto bg-neutral-primary px-12 py-12 fieldset bg-base-200 border-default rounded-box w-lg border p-4">
